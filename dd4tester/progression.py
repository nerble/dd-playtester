...
_MUD_SCHOOL_RESEARCH_POLICY = replace(
    ...
    evidence=(
        *_MUD_SCHOOL_ARENA_POLICY.evidence,
        ...
        "Live run 105: the explicit kobold probe found the target had despawned before attack; it received no combat or XP signal and returned safely without engaging either orc.",
